...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Version.severity_comment'
        db.add_column('version', 'severity_comment',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.severity_comment'
        db.delete_column('version', 'severity_comment')
